...
(Q6_1, Q7_1, Q9_1, Q9_2, Q10_1)을 최우선으로 활용하세요.
...
function buildUserMessage(
  ...
  const q7Detail =
    q7 === "있어요"
      ? a("Q7_1") || "있다고 했으나 구체적으로 미입력"
      : "없음";

  const q9 = a("Q9");
  let q9Detail: string;
  if (q9 === "있어요") {
    q9Detail = a("Q9_1") || "있다고 했으나 구체적으로 미입력";
  } else if (q9 === "있긴 한데 흐릿해요") {
    q9Detail = `흐릿한 아이디어: ${a("Q9_2") || "미입력"}`;
  } else {
    q9Detail = q9;
  }
